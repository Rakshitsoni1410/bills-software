  ...
  async function confirmDelete() {
    ...
    try {
      ...
      setCustomers((current) =>
        current.filter((customer) => customer._id !== customerToDelete._id),
      );
  ...
  return (
    <div className="space-y-7">
      ...
      <ConfirmModal
        ...
        description="Please confirm before removing this customer."
        ...
        warningText="The customer will be permanently removed from your customer database."
      >
        {customerToDelete && (
          <div className="flex items-center gap-3">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-100 to-cyan-100 text-sm font-bold text-indigo-700">
              {customerToDelete.name?.slice(0, 2).toUpperCase()}
            </div>
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="inline-flex items-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-2 rounded-xl border border-indigo-100 bg-indigo-50 px-3 py-2 text-xs font-bold text-indigo-600 transition-all hover:border-indigo-200 hover:bg-indigo-100 hover:text-indigo-700"
