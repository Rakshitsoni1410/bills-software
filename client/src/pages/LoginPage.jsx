...
export default function LoginPage() {
  ...
  function updateLogin(value) {
    ...
    setForm((current) => ({ ...current, login: nextValue }));
  }
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-white/10 bg-white p-6 shadow-2xl shadow-black/30 sm:p-8">
              ...
              {isLocked && (
                <div className="mb-5 flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 px-4 py-4 text-sm text-red-700">
                  ...
                  <div>
                    <p className="font-bold text-red-800">Account Locked</p>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={isLocked}
                      className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-11 pr-4 text-sm text-slate-800 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-indigo-400 focus:bg-white focus:ring-4 focus:ring-indigo-100 disabled:cursor-not-allowed disabled:opacity-50"
                      value={form.login}
