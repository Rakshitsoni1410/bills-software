...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-indigo-900 relative overflow-hidden flex items-center justify-center px-4 py-10">
      ...
      />
      <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-indigo-500/40 rounded-full blur-3xl blob" style={{ animationDelay: "8s" }} />
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-canvas rounded-2xl shadow-2xl shadow-black/30 p-7 sm:p-9 relative">
          ...
          <p className="text-sm text-ink/60 text-center mb-7">Login to manage your billing</p>
