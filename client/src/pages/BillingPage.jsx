      ...
      <div>
        <div className="flex items-center gap-3 mb-4 no-print flex-wrap">
          ...
          <button
            ...
            className="text-sm bg-green-600 text-white rounded-md px-3 py-1.5 hover:bg-green-700"
          >
            Print / Save PDF
          </button>
          <button
            onClick={whatsappShare}
            className="text-sm bg-[#25D366] text-white rounded-md px-3 py-1.5 hover:opacity-90"
          >
            Share on WhatsApp
          </button>
          <button
          ...
          {items.map((item) => (
            <div key={item.id} className="grid grid-cols-2 sm:grid-cols-[3fr_1fr_1fr_1fr_32px] gap-2 items-center">
              ...
              <button
                ...
                className="text-gray-400 hover:text-red-600 justify-self-end sm:justify-self-auto"
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-5 mb-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-50 rounded-md p-4">
            ...
            <div className="flex justify-between text-base font-medium border-t border-gray-200 mt-2 pt-2">
              <span>Total</span>
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="w-full sm:w-auto mt-4 bg-blue-600 text-white text-sm font-medium px-5 py-2.5 rounded-md hover:bg-blue-700 disabled:opacity-60"
        >
