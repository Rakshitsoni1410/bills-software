          ...
          <table className="w-full border-collapse text-[10px] sm:text-xs">
            <thead>
              <tr className="bg-slate-900 text-white">
                ...
                <th className="w-16 px-2 py-3 text-center font-semibold">
                  GST
                </th>
            ...
            <tbody>
              {invoice.items?.map((item, index) => {
                ...
                const discountAmount =
                  storedDiscount || fallbackDiscount;
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 py-4 text-right text-emerald-700">
                      {discountAmount > 0
                    ...
                    <td className="px-2 py-4 text-right font-semibold text-slate-900">
                      ₹{formatMoney(taxable)}
                    </td>
                  </tr>
                );
        ...
        <div className="mt-7 flex justify-end">
          <div className="w-full sm:w-[360px]">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <TotalRow
                ...
                value={
                  ...
                  Number(invoice.subtotal || 0) +
                    Number(invoice.itemDiscountTotal || 0) +
                    Number(invoice.invoiceDiscountAmount || 0)
                }
              />

              {Number(invoice.itemDiscountTotal || 0) > 0 && (
                <TotalRow
                  label="Item Discounts (-)"
                  value={invoice.itemDiscountTotal}
                />
              )}

              {Number(invoice.invoiceDiscountAmount || 0) > 0 && (
                <TotalRow
              ...
              {Number(invoice.extraChargeAmount || 0) > 0 && (
                <TotalRow
                  label={invoice.extraChargeName || "Extra Charge"}
                  value={invoice.extraChargeAmount}
                />
              )}
